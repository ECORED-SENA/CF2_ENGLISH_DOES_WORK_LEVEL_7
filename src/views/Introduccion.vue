        ...
        .col-lg-7(data-aos="fade-left")
          .tarjeta.bg-white.p-4.p-lg-5.tarjeta-intro 
            p.mb-4.p-3.p-lg-0 Este nivel de formación bilingüe se enfoca en narrar recuentos anecdóticos y experiencias de vida; para esto, se necesita saber usar los tiempos 
              ...
              | útiles para decir cómo o de qué manera se hicieron las cosas, y a usar las 
              span.r--1 frases exclamativas, 
            ...
            .tarjeta-intro__cta.mx-0.mx-lg-5
              a.anexo.my-4.mb-lg-0(:href="obtenerLink('downloads/doc1.pdf')" target="_blank" style='background-color: #3c3fa7')
                ...
                .anexo__texto()
                  p
                    span.r--2.fw-normal #[b Anexo.] Si desea practicar, el siguiente PDF presenta los textos del siguiente video, tanto en inglés como en español.
    figure
      .video
        iframe(width="560" height="315" src="https://www.youtube.com/embed/E7NQDVOZWMo" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen)
...
<style lang="sass">
.bg-intro
  background-image: url('../assets/curso/temas/intro/bg-intro.png')
